  ...
  ({ className, variant = "secondary", size = "default", ...props }, ref) => {
    ...
    return (
      <Button
        ...
        size={size}
        className={cn(
          "font-gigabold font-grotesk absolute h-8 w-8 rounded-r-full !py-5 !pl-2 !pr-3",
  ...
  ({ className, variant = "secondary", size = "default", ...props }, ref) => {
    ...
    return (
      <Button
        ...
        size={size}
        className={cn(
          "font-gigabold font-grotesk absolute right-2 h-8 w-8 rounded-l-full !py-5 !pl-3 !pr-2",
          orientation === "horizontal" ? "top-1/2 -translate-y-1/2" : "-top-12 left-1/2 -translate-x-1/2 rotate-90",
          className,
        )}
